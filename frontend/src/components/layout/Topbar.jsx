...
export default function Topbar() {
  ...
  return (
    <header className="h-16 border-b border-border bg-card flex items-center justify-between px-4 sm:px-6 sticky top-0 z-40 shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="p-2 rounded-xl text-muted-foreground hover:bg-rose-500/10 hover:text-rose-400 transition-colors"
          title="Logout"
        >
